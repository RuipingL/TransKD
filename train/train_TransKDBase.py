...
def train(args, model, teacher):
    ...
    if args.dataset == 'cityscapes':
        savedir = f'../save/Testbatch{args.batch_size}/Optimization/TransKDBase'
    elif args.dataset == 'ACDC':
        savedir = f'../save/Testbatch{args.batch_size}-ACDC/Optimization/TransKDBase'
    else:
        assert 'Dataset does not exist'
    ...
    for epoch in range(start_epoch, args.num_epochs+1):
        ...
        for step, (images, labels) in enumerate(loader):
            ...
            elif args.knowledge_distillation_loss == 'CWloss' or args.knowledge_distillation_loss == 'KL':
                loss_cwd = 0.0
...
if __name__ == '__main__':
    ...
    parser.add_argument("--knowledge-distillation-loss", default="hcl", choices= ['hcl', 'CWloss','KL'])
