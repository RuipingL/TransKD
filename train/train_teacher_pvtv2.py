...
class MyCoTransform(object):
    def __init__(self, augment=True, height=512, model='pvt_v2_b2'):
    ...
    def __call__(self, input, target):
        ...
        if self.model.startswith('pvt_v2_b2'):
...
def train(args, model):
    ...
    if args.height != 512:
        savedir = f'../save_pvtv2-{args.height}/{args.savedir}'
...
def main(args):
    if args.dataset == 'cityscapes':
        savedir = f'../save_pvtv2/teachers'
        if args.height != 512:
            savedir = f'../save_pvtv2-{args.height}/teachers'

    elif args.dataset == 'ACDC':
        savedir = '../save_pvtv2/ACDC_teachers'
    else:
        assert 'Dataset does not exist'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', default="pvt_v2_b2", choices=["pvt_v2_b2","pvt_v2_b3","pvt_v2_b4","pvt_v2_b5"], help ='Teacher for Knowledge Distillation. Default: pvt_v2_b2')
